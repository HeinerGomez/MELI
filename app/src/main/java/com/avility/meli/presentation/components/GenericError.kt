 ...
 * para los casos en donde se detecte algún error que impida la busqueda de productos de manera correcta
 */
@Composable
fun GenericError(
    messageError: String = "Error Desconocido"
) {
    val composition by rememberLottieComposition(LottieCompositionSpec.RawRes(R.raw.erroralert))
